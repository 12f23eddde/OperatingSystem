...
// [lab5] change length of file name
#define FileNameMaxLen        ((SectorSize - sizeof(bool) - sizeof(int))/sizeof(char) - 1)
// for simplicity, we assume file names are <= 251 characters long
...
class Directory {
public:
    Directory(int size, int dirSector=-1);        // Initialize an empty directory
